"""Run only the Transformer experiments in the old power_forecast project.

Examples:
    python train_transformer.py --horizon 90 --epochs 80 --seeds 0 1 2 3 4
    python train_transformer.py --horizon 365 --epochs 100 --seeds 0 1 2 3 4
    python train_transformer.py --horizon all --epochs-short 80 --epochs-long 100

Weather preprocessing example:
    python train_transformer.py --horizon 90 --weather-csv data/MENSQ_92_previous-1950-2024.csv --force-split
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run only Transformer experiments.")
